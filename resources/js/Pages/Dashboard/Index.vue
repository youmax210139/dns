              ...
              <table class="table">
                <tbody>
                  <tr>
                    ...
                    <td
                      class="text-left"
                    >Sign contract for "What are conference organizers afraid of?"</td>
                  ...
                  <tr>
                    ...
                    <td
                      class="text-left"
                    >Lines From Great Russian Literature? Or E-mails From My Boss?</td>
                    <td class="td-actions text-right">
                      <button
                        type="button"
                        rel="tooltip"
                  ...
                  <tr>
                    ...
                    <td
                      class="text-left"
                    >Flooded: One year later, assessing what was lost and what was found when a ravaging rain swept through metro Detroit</td>
                    <td class="td-actions text-right">
                      <button
                        type="button"
                        rel="tooltip"
...
export default {
  mounted() {
    ...
    this.createChart("lineChartExample", {
      type: "line",
      responsive: true,
      data: {
        labels: [
    ...
    this.createChart("lineChartExampleWithNumbersAndGrid", {
      type: "line",
      responsive: true,
      data: {
    ...
    this.createChart("barChartSimpleGradientsNumbers", a);
  },
  methods: {
